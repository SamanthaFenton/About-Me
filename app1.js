...
let qone = confirm(Can I make a Dolphin noise ???);
console.log(q1)
...
let qtwo = confirm("Do I enjoy surprises???");
console.log(q2)
...
let qthree = confirm("Do I speak more than 1 language?")
console.log(q3)
...
let qfour = confirm("Have I ever lived in another country???")
console.log(q4)
...
let qfive = confirm("Have I ever been on a TV gameshow???")
console.log(q5)
